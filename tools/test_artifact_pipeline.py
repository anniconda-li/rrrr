...
from core.paths import DEFAULT_CAMERA_TEST_IMAGE, ensure_runtime_dirs
...
async def run_test(
    ...
    print_separator("总耗时")
    print(f"  {total_cost:.3f}s (视觉={vision_cost:.3f}s 检索={search_cost:.3f}s 讲解={guide_cost:.3f}s)")
